...
var globalPictorialSetUi = function (module, seq) {
    ...
    var pictorialDetailview = function (param) {
        document.location.replace("/product/detail.html" + param);
    };
    ...
    if (module.find("li").length < 1) {
        ...
        $name
            ...
            .add($detail)
            .bind("click", function () {
                pictorialDetailview($data.param);
            });
        ...
        if (product_price_ref_display != "") {
            $price_ref.addClass(product_price_ref_display);
        }
    }
};
$(function () {
        ...
        var $effect = {
            ...
            setEvent: function () {
                this.$event = {
                     ...
                     */
                    action: function () {
                        $effect.$next.bind("click", function (e) {
                            e.stopPropagation();
                            $effect.next();
                        });
                        $effect.$prev.bind("click", function () {
                            $effect.prev();
                        });
                        $effect.$module
                            .find("li")
                            .unbind()
                            .bind("click", function () {
                                globalPictorlControl($effect.$module);
                            });
                    },
